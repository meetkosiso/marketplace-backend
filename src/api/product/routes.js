...
router.get("/init/product", initProduct);
 ...
 * the admin can only modify by patching
 */
router.patch("/products/approval/:productId", isValidVendor, product.approval);
 ...
 * @apiError 401 master access only.
 */
router.delete("/products/vendor/:productIds(*)", isValidVendor, product.destroy);
 ...
 * @apiError 401 master access only.
 */
router.delete("/products/admin/:productIds(*)", product.destroy);
