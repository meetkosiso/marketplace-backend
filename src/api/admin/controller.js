...
export function findContract(req, res) {
  return helper.getContractAddress(1234567890)
    .then(result => success(res, 200, result, "OK!"))
    .catch(err => fail(res, 500, `Contract Error.\r\n${err.message}`));
}
...
export async function update(req, res) {
  ...
  if (!isComplete && data.email !== "") newObject.email = data.email.toLowerCase();
