 ...
 */
router.get("/customers/customer", isValidCustomer, customer.findOne);
 ...
 * @apiError 404 Customer not found.
 */
router.get("/customers/verify/:attribute/:value", isValidCustomer, customer.findVerify);
 ...
 */
router.put("/customers/customer", isValidCustomer, customer.update);

router.put("/customers/password/update", isValidCustomer, customer.passwordUpdate);
